...
<head>
    <meta charset="utf-8">
    <title>Laporan Penjualan Tertinggi</title>
    <style>
        body {
...
<body>
    ...
    <div class="info-section">
        ...
        <div class="info-row">
            ...
            <span>{{ $summary['presentase_data'] }} data teratas (minimum 5 transaksi)</span>
        </div>
    </div>
    ...
    <div class="summary-section">
        <h3 style="margin-top: 0;">📈 Ringkasan Penjualan Tertinggi</h3>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="{{ $index == 0 ? 'ranking-1' : ($index == 1 ? 'ranking-2' : ($index == 2 ? 'ranking-3' : '')) }}">
    ...
    @else
    <div class="no-data">
        <h3>Tidak ada data penjualan tertinggi untuk periode ini</h3>
